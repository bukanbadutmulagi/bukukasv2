...
system("git clone https://github.com/bukanbadutlagi/bukukasv2");
system("cd bukukasv2");
system("ls");
} else {
	die;
...
system("clear");
system("figlet         MENU");
echo "\n[01] GetLink Payment [Minimal 25k Profil Callmedan]";
echo "\n[02] Topup Dana Virtual Account [Profil Callmedan]";
echo "\n[03] BRI to SINARMAS [Profil Callmedan]";
echo "\n[04] SINARMAS to BRI [Profil Callmedan]";
echo "\n[05] Cimb Niaga x Dana [Profil Dandang]";
echo "\n[06] Maybank X Neo Top up [Profil Dandang]";
echo "\n[07] Mandiri X PostPay [Profil Dandang]";
echo "\n[08] Permata X Gojek [Profil Dandang]";
echo "\n[09] Shopee X Bukukas [Profil Dandang]";
echo "\n[10] Ganti BRI Payment [Profil Dandang]";
echo "\n[11] getToken Bukukas";
